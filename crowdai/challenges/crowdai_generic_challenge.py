...
class crowdAIGenericChallenge(BaseChallenge):
    def __init__(self, api_key, challenge_id, config):
        self.challenge_id = challenge_id
        super(
            crowdAIGenericChallenge,
            self).__init__(self.challenge_id, api_key, config, grader_id="crowdAI_GRADER_POOL")
        self._connect()
        self._authenticate()
